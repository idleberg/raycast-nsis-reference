import { ActionPanel, Detail, Icon, ImageMask, List, PushAction } from "@raycast/api";
...
function editLink(name: string, category: string): string {
...
function mapTintColor(category: string): string {
  switch (category) {
    case 'Commands':
      return '#4caf50';
